...
SELECT Game,COUNT(Gamertag) TotalPlayers
FROM ESL
GROUP BY Game 
...
SELECT Country,COUNT(Gamertag) TotalPlayers
FROM ESL
GROUP BY Country
...
SELECT Country,ROUND(SUM(TotalUSDPrize),2) Prize
FROM ESL 
GROUP BY Country
ORDER BY Prize DESC
...
SELECT Country,ROUND(AVG(TotalUSDPrize),2) Prize
FROM ESL 
GROUP BY Country
ORDER BY Prize DESC
...
SELECT Country,ROUND(MAX(TotalUSDPrize),2) Prize
FROM ESL 
GROUP BY Country
ORDER BY Prize DESC
...
SELECT FirstName,LastName,Gamertag,ROUND(SUM(TotalUSDPrize),2) Prize
FROM ESL 
GROUP BY FirstName,LastName,Gamertag
ORDER BY Prize DESC
...
SELECT Game,ROUND(AVG(TotalUSDPrize),2) AvgEarnings 
FROM ESL 
GROUP BY Game 
...
SELECT Game,ROUND(AVG(TotalUSDPrize),2) Prize
FROM ESL 
GROUP BY Game 
ORDER BY Prize DESC
...
SELECT Game,ROUND(SUM(TotalUSDPrize),2) Prize
FROM ESL 
GROUP BY Game 
ORDER BY Prize DESC
...
SELECT Genre,ROUND(AVG(TotalUSDPrize),2) AvgEarnings 
FROM ESL 
GROUP BY Genre
ORDER BY AvgEarnings DESC
...
SELECT Genre,ROUND(SUM(TotalUSDPrize),2) TotalEarnings 
FROM ESL 
GROUP BY Genre
...
SELECT TOP 5 FirstName,LastName,Gamertag,SUM(TotalUSDPrize) TotalEarnings
FROM ESL 
WHERE Game = 'Dota 2'
GROUP BY FirstName,LastName,Gamertag 
ORDER BY TotalEarnings DESC
